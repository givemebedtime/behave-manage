            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="add_block_web.php">Student</a>
                        </li>
                        <li class="nav-item ">
        ...
        <div class="container">
            <form action="add_block.php" method="post">
                <div class="text-content">
                    ...
                    <h4>Behavior Score Management</h4>
                    <!-- <label for="chain_id">Enter Chain ID:</label>
                    <input type="text" name="chain_id" id="chain_id"  required>
        
                    <label for="data">Enter Data:</label>
                    <textarea type="text" name="data" id="data" class="form-control"></textarea> -->
